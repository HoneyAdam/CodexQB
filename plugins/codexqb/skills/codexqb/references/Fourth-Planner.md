...
İlgili Codex becerilerini/eklentilerini kapsamına göre kullan: implementation için superpowers:executing-plans veya superpowers:subagent-driven-development, kod değişikliklerinde superpowers:test-driven-development, bitirmeden önce superpowers:verification-before-completion, güvenlik/policy/secret/command execution işleri için codex-security. GitHub publish/PR işleri sadece açıkça istendiğinde kullan.
