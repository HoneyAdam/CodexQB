...
- Apply modes are `direct`, `subagent_serial`, `external_superpowers`, and `no_action`.
...
Ready condition:
- Goal prompt preserves the canonical Step 4 Goal Run Contract and explicit stop gates.
