# Goal Spec: Step 1.5 Autopsy

Stage ID: `step15`

Purpose: compile a Goal prompt that reviews an existing or partially built repository and creates `Planner-docs/Autopsy.md` plus optional comprehension artifacts.
...
Ready condition:
- Goal prompt states whether Step 1.5 applies and names the planner-doc files that may be written.
