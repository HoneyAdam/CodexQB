# CodexQB Project Ontology

CodexQB uses `Planner-docs/Project-Ontology.md` as an optional durable project-understanding artifact.

## Purpose

The ontology helps Codex and coding agents understand the project's language, boundaries, workflows, and invariants before planning or implementation.
