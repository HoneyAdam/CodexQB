# CodexQB Assessment and Budget Notes

CodexQB should assess more than calendar effort.
...
- validation strength;
- expected Goal mode run size;
- rough token/context pressure;
- whether subagents are useful or overkill.

## Token and Usage Estimates

CodexQB may provide rough token/context estimates, but must not pretend they are exact.
