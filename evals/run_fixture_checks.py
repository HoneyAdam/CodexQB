#!/usr/bin/env python3
"""Run deterministic CodexQB fixture checks.

These checks do not execute Codex. They keep the fixture corpus and expected
...
def fail(message: str) -> None:
    print(f"fixture_eval_failed={message}")
    raise SystemExit(1)
...
def main() -> int:
    ...
    print(f"fixture_eval_checks=passed")
